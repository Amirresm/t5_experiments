...
export base_config_title="peftLM_${job_name}_${model_name}_${dataset_name}_${peft_name}"
export config_title="testpure_${job_name}_${model_name}_${dataset_name}_${peft_name}"
...
export script_path="$prog_root/run_summarization_peft.py"
"$main_script_path"
