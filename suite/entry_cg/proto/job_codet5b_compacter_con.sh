...
base_config_title=""
lang="pycon"
config_title="codet5_base_compacter_${lang}_b16_conala"
...
parent_path=/home/amirresm/projects/def-fard/amirresm/outputs/rr_experiments_cg/$lang/$config_title

data=$storage_root/data/conala-corpus
...
text_column="rewritten_intent"
summary_column="snippet"
text_tokenized=0
summary_tokenized=0
...
# Others
train_file="${data}/conala-train.json"
eval_file="${data}/conala-test.json"
test_file="${data}/conala-test.json"

export HF_EVALUATE_OFFLINE=1
export HF_DATASETS_OFFLINE=1

touch "${output_dir}/memuse.txt"
touch "$output_dir/job_report.log"
