...
config_title="t5_base_full_python_no_hint"
...
script_path=$prog_root/run_summarization.py
...
parent_path=/home/amirresm/projects/def-fard/amirresm/outputs/t5_experiments/$config_title
...
generation_output_path=$output_dir/gen_output_test
